...
% - find the means of columns so as to have the mean-adjusted data B
...
%   order of vectors is different. in SVD, U = Vt for this square matrix.
% - rotate B by multiplying it by rotation matrix U, and find the
